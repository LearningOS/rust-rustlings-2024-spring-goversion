...
// All items cost 5 tokens, 
// and whenever you purchase items there is a processing fee of 1 token. 
...
// Since the player typed in the quantity, though, we get it as a string-- and they
